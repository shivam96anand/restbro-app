...
export class TargetAdHocPrefill {
   ...
   */
  static prefillAuth(container: HTMLElement, auth: any, setupAuthConfigFn: () => void): void {
    const authType = container.querySelector('#target-auth-type') as HTMLSelectElement;
   ...
   */
  static prefillBody(container: HTMLElement, body: any, toggleBodyEditorFn: (type: string) => void): void {
